...
def extract_ecg_signal_from_image(image_path, num_points=500):
    ...
    _, global_thresh = cv2.threshold(enhanced, 85, 255, cv2.THRESH_BINARY)
    inverted_global = cv2.bitwise_not(global_thresh)
    blurred = cv2.GaussianBlur(inverted_global, (5, 5), 0)
...
le = joblib.load(r"C:\Users\PC\Desktop\PROJECT2\6lead_label_encoder.pkl")
mlp = load_model(r"C:\Users\PC\Desktop\PROJECT2\6lead_mlp.keras")
rfc = joblib.load(r"C:\Users\PC\Desktop\PROJECT2\6lead_random_forest_model.pkl")
scaler = joblib.load(r"C:\Users\PC\Desktop\PROJECT2\6lead_scaler.pkl")
xgb = joblib.load(r"C:\Users\PC\Desktop\PROJECT2\6lead_xgboost_model.pkl")
model = load_model(r"C:\Users\PC\Desktop\PROJECT2\6lead_cnn.keras")
imputer = joblib.load(r"C:\Users\PC\Desktop\PROJECT2\6lead_imputer.pkl")
LEAD_BOXES = {
    'I':   (185,   0, 635,  194),
    'II':  (185,  194, 635,  187),
    'III': (185, 383, 635,  175),
...
PREDICTION_ROOT_DIR = "prediction_images_6leads"
...
def predict_ecg_condition(image_path):
    ...
    resized = cv2.resize(img, (1152, 1152))
    ...
    return f"✅ Predicted Label: normal, Confidence: 1.00"
